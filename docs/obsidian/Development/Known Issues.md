...
<!-- Updated 2026-08-24 (feat/cross-harness-permissions, v2.28.0 hardening): cross-shell semantic classification, immutable launch-policy attestation and private command-hash audit landed; native-Windows Claude's lack of an OS containment boundary remains explicit -->
