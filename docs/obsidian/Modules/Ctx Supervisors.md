...
- **Files:** `src/commands/ctx/run_loop.rs`, `exec.rs`, `wrap.rs` (the three supervisors), plus `signal.rs`, `supervise.rs`, `term.rs`
...
- **If changed:** [[Ctx Subsystem]], [[Ctx Adapters]], [[Rot Engine]], [[Usage and Pacing]], [[Script Runner]], [[Decision Log]]
