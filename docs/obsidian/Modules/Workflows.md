...
zirv frontend review --verdict pass|fail --product-specificity 1..5 --user-journey 1..5 ... --resilience 1..5 [--finding <defect>] [--agent <id>] [--model <id>]
